...
{
    public class SpiderQueenController : KGEnemyController
    {
#if UNITY_EDITOR
        public static SpiderQueenController instance;
        ...
        {
            m_SkeletonAnim.AnimationName = "start";
        ...
        public override void DoDamage()
        {
            ...
            {
                m_SkeletonAnim.state.SetAnimation(0, "damage2", false);
                ChangeState();
                return;
            }
            if (character.curState == animToState["damage2"])
            {
